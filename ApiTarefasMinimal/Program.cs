...
//GET pra retornar "Brasil sil sil..."
app.MapGet("/", () => "Brasil sil sil...");

//GET pra retornar frases
app.MapGet("frases", async () =>
    await new HttpClient().GetStringAsync("https://ron-swanson-quotes.herokuapp.com/v2/quotes")
);

//GET pra retornar lista de tarefas
app.MapGet("/tarefas", async (AppDbContext db) => await db.Tarefas.ToListAsync());

//GET pra retornar tarefas por ID
...
//PUT usado paraa atualizar uma tarefa por ID
...
//DELETE usado pra excluir uma tarefa por ID
